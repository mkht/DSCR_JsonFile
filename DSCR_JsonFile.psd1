#
# モジュール 'DSCR_JsonFile' のモジュール マニフェスト
#
# 生成者: mkht
#
# 生成日: 2018/07/10
...
@{
    ...
    GUID                 = '5975bde6-4598-448c-831f-6794d86fde9b'
    ...
    # このモジュールの機能の説明
    Description          = 'PowerShell DSC Resource to create JSON file.'
    ...
    DscResourcesToExport = @('cJsonFile')
    ...
    PrivateData          = @{
        PSData = @{
            ...
            Tags       = ('DesiredStateConfiguration', 'DSC', 'DSCResource', 'JSON')

            # A URL to the license for this module.
            LicenseUri = 'https://github.com/mkht/DSCR_JsonFile/blob/master/LICENSE'

            # このプロジェクトのメイン Web サイトの URL。
            ProjectUri = 'https://github.com/mkht/DSCR_JsonFile'
